...
def scrape(s=None, ads_from=0, ads_to=0, gender='male', age_group='19-22', country='', language='', only_emails=False):
    ...
    if ads_to <= ads_from:
        ...
        scrape(s, ads_from, ads_to, gender, age_group, country, language,only_emails)
...
def get_values():
    ...
    scrape(ads_from=0,ads_to=number_of_ads,gender=gender,age_group=age_group,country=country,only_emails=only_emails)
